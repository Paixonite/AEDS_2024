...
int tempoSegundosCountdown = tempoSegundosTotal; // Variavel de controle para o cronometro
int tempoMilesimosItens = 0; //Variavel de controle para criação de itens
int tempoMilesimosIntervaloItens = 2000; // Intervalo de tempo em milésimos entre a criação de itens

boolean pausado = false; //Guarda se o programa sera executado normalmente ou na tela de pause
boolean terminado = false; //Guarda se o programa sera executado normalmente ou na tela final
boolean ganhou = true; //Variavel que define qual tela final sera mostrada
boolean click = false; //Guarda se o houve um unico clique no mouse

PImage  personagemImg1,personagemImg2,personagemImg3,personagemImg4,
gameOverImg1, gameOverImg2; //Imagens utilizadas nas telas
...
void setup()
{
  ...
  personagemImg1 = loadImage("paradoFrente.png");
  personagemImg2 = loadImage("paradoDireita.png");
  personagemImg3 = loadImage("paradoTras.png");
  personagemImg4 = loadImage("paradoEsquerda.png");

  chao = new celula(true, loadImage("chao.png"), 0);
  cofre = new celula(false, loadImage("cofre.png"), 0);
  armadilha = new celula(true, loadImage("armadilha.png"), 0);
  parede = new celula(false, loadImage("parede.png"), 0);
...
void imprimirPersonagem()
{
  ...
  image(p.image, p.posX * h, p.posY * w, h, w);
}
